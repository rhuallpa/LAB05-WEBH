...
const permissionModelUID = 'plugins::auth.permission'
...
const shouldRunMigration = (definition, previousDefinition) => {
  ...
  const targetedFieldsHaveChanged =
    hadFieldsButNotProperties && hasPropertiesButNotFields
...
module.exports = {
  shouldRun: {
    ...
    after(options, context) {
      ...
      return (
        shouldRunMigration(definition, previousDefinition) &&
