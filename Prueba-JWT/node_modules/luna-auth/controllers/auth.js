...
const forgotPassword = async ({ email } = {}) => {
  ...
  const resetPasswordToken = luna.admin.services.token.createToken()
  await luna.admin.services.user.updateById(user.id, { resetPasswordToken })
...
const resetPassword = async ({ resetPasswordToken, password } = {}) => {
  ...
  return luna.admin.services.user.updateById(matchingUser.id, {
    password,
