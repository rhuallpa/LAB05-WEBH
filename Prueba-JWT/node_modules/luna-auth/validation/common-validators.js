...
const roles = yup.array(yup.lunaID()).min(1)
          ...
          .shape({
            ...
            subject: yup
              ...
              .test(
                ...
                function (subject) {
                  const action = getActionFromProvider(
                    this.options.parent.action
                  )
            ...
            properties: yup
              ...
              .test(
                ...
                function (properties) {
                  ...
                  const hasNoProperties =
                    isEmpty(properties) || isNil(properties)
              ...
              .test(
                ...
                async function (properties = {}) {
                  ...
                  try {
                    await fieldsPropertyValidation(action).validate(
                      properties.fields,
                      {
                        strict: true,
                        abortEarly: false
